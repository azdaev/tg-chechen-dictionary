...
- **Умный поиск** — подсказки лемм для словоформ («яблоками» → «Яблоко»), пословный разбор фраз, ё/е и палочка в любом написании (`г1ала`, `гIала`, `гӏала`); палочку можно и вовсе не ставить — «чегӏардиг» находит «чӏегӏардиг»
