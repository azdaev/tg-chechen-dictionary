...
// stored display names fresh for the leaderboard.
func (r *Repository) RecordQuizAnswer(ctx context.Context, userID int64, username, firstName string, correct bool) error {
	...
	_, err := r.db.ExecContext(
		ctx,
		`INSERT INTO quiz_stats (user_id, username, first_name, correct_count, total_count)
		 VALUES (?, ?, ?, ?, 1)
